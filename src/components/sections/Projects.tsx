  ...
  const projects = [
    {
      ...
      description:
        "Modern real-time chat application with Socket.io, supporting authenticated users, persistent messaging, and smooth UI transitions designed for scalability.",
      image:
    ...
    },
    {
      ...
      description:
        "Chrome extension that translates YouTube subtitles on the fly using Google Translate API, improving accessibility for multilingual users.",
      image:
    ...
    },
    {
      ...
      description:
        "Sleek 3D web application to track expenses with stunning interactive UI using Three.js. Features expense listing, tracking, and animated responsive design.",
      image:
    ...
    },
    {
      ...
      description:
        "Fashion-forward e-commerce frontend built for Gen Z users with dynamic product cards, category filters, and stylish responsive layout.",
      image:
    ...
    },
    {
      ...
      description:
        "EdTech platform UI for course discovery and learning management. Built with modular React components and designed for scalability.",
      image:
    ...
    },
    {
      ...
      description:
        "Fun browser-based version of the classic Snake game developed using vanilla JavaScript with keyboard controls, score tracking, and retro styling.",
      image:
